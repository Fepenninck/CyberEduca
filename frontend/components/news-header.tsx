...
export function NewsHeader() {
  return <header className="reference-header">
    <div className="reference-header-inner">
      ...
      <div className="reference-actions"><Link href="/dashboard" className="nav-item">Dashboard</Link><Link href="/em-breve" className="nav-item">Entrar</Link><Link href="/trilhas" className="reference-cta">Começar</Link></div>
