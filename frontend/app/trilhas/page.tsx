  ...
  return (
    <main className="app-shell">
      ...
      <footer className="ce-footer tracks-footer">
        ...
        </div></div><div className="ce-footer-bottom"><span>© 2026 CyberEduca+. Todos os direitos reservados.</span><div><Link href="/politicas#politica-de-privacidade">Privacidade</Link><Link href="/politicas#cookies">Cookies</Link><Link href="/politicas#termos-de-uso">Termos de uso</Link></div></div></div>
      </footer>
    </main>
  )
}
